    ...
    <div class="login-center-frame">
        ...
        <form style="width: 100%;">
          <div class="login-form-row">
            <label for="email" class="login-form-label">Member ID</label>
            <input type="text" id="email" name="email" class="login-form-input" placeholder="Insert Member ID" autocomplete="username">
          </div>
          <div class="login-form-row">
